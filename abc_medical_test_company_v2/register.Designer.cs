namespace abc_medical_test_company_v2
{
    partial class frmregister
    {
        ...
        private void InitializeComponent()
        {
            ...
            // panel_right
            // 
            this.panel_right.Controls.Add(this.cmbrole);
            this.panel_right.Controls.Add(this.lblrole);
            this.panel_right.Controls.Add(this.txtlname);
            this.panel_right.Controls.Add(this.txttelno);
            this.panel_right.Controls.Add(this.txtemail);
            this.panel_right.Controls.Add(this.txtfname);
            this.panel_right.Controls.Add(this.lbllname);
            this.panel_right.Controls.Add(this.lbltelno);
            this.panel_right.Controls.Add(this.lblemail);
            this.panel_right.Controls.Add(this.lblfname);
            this.panel_right.Controls.Add(this.txtpassword);
            this.panel_right.Controls.Add(this.lblpassword);
            this.panel_right.Controls.Add(this.txtusername);
            this.panel_right.Controls.Add(this.lblusername);
